...
THREE.Lut.prototype = {
	...
	setLegendLabels: function ( parameters, callback ) {
		...
		contextTitle.font = 'Normal ' + this.legend.labels.fontsize * 1.1 + 'px ' + this.legend.labels.fontface;
		...
		contextTitle.fillText( this.legend.labels.title.toString() + this.legend.labels.um.toString(), canvasTitle.width/2 - textWidth/2 , canvasTitle.height/2 - this.legend.labels.fontsize/2 );
		...
		spriteTitle.scale.set( 2/2, 1/2, 1.0/2);
		...
		if ( this.legend.layout == 'horizontal' ) {
			...
			spriteTitle.position.set( this.legend.position.x - ( this.legend.dimensions.height/2  ), this.legend.position.y  , this.legend.position.z );
		...
		if ( this.legend.labels.ticks > 0 ) {
			...
			for ( var i = 0; i < this.legend.labels.ticks; i ++ ) {
				...
				contextTick.fillText( value.toString(), canvasTitle.width/2 - textWidth/2 , canvasTitle.height/2 - this.legend.labels.fontsize/2  );
				...
				spriteTick.scale.set( 2/2, 1/2, 1.0/2 );
				...
				// if ( this.legend.layout == 'vertical' ) {
					...
					spriteTick.position.set( position-0.05, this.legend.position.y - this.legend.dimensions.width * offset, this.legend.position.z );
				}
...
THREE.ColorMapKeywords = {
	...
	"matlab":    [ [ 0.0, '0x352A87' ], [ 0.2, '0x0D75DC' ], [ 0.5, '0x2EB7A3' ], [ 0.8, '0xF1B94A' ],  [ 1.0, '0xF8FA0D' ] ],
